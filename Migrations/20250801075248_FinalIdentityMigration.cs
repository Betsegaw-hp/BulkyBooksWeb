...
{
    /// <inheritdoc />
    public partial class FinalIdentityMigration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Step 4: Data migration - migrate users from LegacyUsers to AspNetUsers with all required fields
            migrationBuilder.Sql(@"
                INSERT INTO AspNetUsers (
                    Id, FullName, AvatarUrl, CreatedAt, UpdatedAt, UserName, NormalizedUserName, 
                ...
                SELECT 
                    ...
                    0 as EmailConfirmed,
                    PasswordHash,
                    CAST(NEWID() AS NVARCHAR(450)) as SecurityStamp,
                    CAST(NEWID() AS NVARCHAR(450)) as ConcurrencyStamp,
                    NULL as PhoneNumber,
